...
int main(int argc, char *argv[])
{
  ...
  printf("Running Testcase: %s (using brute-force approach)\n", argv[1]);
  ...
  // Save the result
  FILE *file = fopen("results_brute.txt", "r");
  ...
  remove("results_brute.txt");
  rename("temp.txt", "results_brute.txt");
